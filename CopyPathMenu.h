...
enum {
    ...
    COPYPATH_MENUITEMID_WSL,
    COPYPATH_MENUITEMID_DOUBLE_QUOTES = 0x10,
    COPYPATH_MENUITEMID_SINGLE_QUOTES = 0x20,
    COPYPATH_MENUITEMID_NEXT = 0x30
};

#define MAX_LABEL_LEN 41

#define COPYPATHMENU_LOGO_WIDTH 16
#define COPYPATHMENU_LOGO_HEIGHT 16
const BYTE COPYPATHMENU_LOGO[] = {0xff, 0xff, 0xf8, 0x1f, 0xe2, 0x47, 0xef, 0xf7, 0xef, 0xf7, 0xe8, 0x77, 0xef, 0xf7, 0xe8, 0x17, 0xef, 0xf7, 0xe8, 0x17, 0xef, 0xf7, 0xe8, 0xf7, 0xef, 0xe7, 0xe0, 0x07, 0xff, 0xff, 0xff, 0xff};
